...
public class WaterJugsState {
    ...
    //the number of operations that were required to achieve this state
    ...
    public WaterJugsState(int jugACapacity, int jugBCapacity, int operationsCount, WaterJugsState parent, String desc){
        a = jugACapacity;
        b = jugBCapacity;
    ...
    {
        return privateCons(0, b, operationsCount + 1, "throw away a");
    }
    //throw away b
    public WaterJugsState move2()
    {
        return privateCons(a, 0, operationsCount + 1, "throw away b");
    }
    ...
    public WaterJugsState move3()
    {
        ...
        int newB = mb;
        int newA = a - (mb - b);
        return privateCons(newA, newB, operationsCount + 1,"put from a into b, a >= mb - b");
    }
    ...
    public WaterJugsState move5()
    {
        ...
        int newA = ma;
        int newB = b - (ma - a);
        return privateCons(newA, newB, operationsCount + 1, "put from b into a, b >= ma - a");
    }
    ...
    {
        return privateCons(ma, b, operationsCount + 1, "fill a to full");
    }

    //fill b to full
    public WaterJugsState move8()
    {
        return privateCons(a, mb, operationsCount + 1, "fill b to full");
    }
